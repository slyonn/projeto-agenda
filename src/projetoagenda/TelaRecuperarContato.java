 ...
 * @author solanje
 */
public class TelaRecuperarContato extends javax.swing.JFrame {

    /**
     * Creates new form TelaRecuperarContato
     */
    public TelaRecuperarContato() {
        initComponents();
        setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
        setResizable(false);
        this.setTitle("Recuperar Contatos");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" Recuperar Contato");
        ...
        jLabel1.setText("Recuperar contato usando:");
        ...
        removerButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\solanje\\Documents\\Sadrak\\ícones\\Sem título-3.png")); // NOI18N
        removerButton.setText("Recuperar Contato");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRecuperarContato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void recuperarContato() {
        if (pesquisarText.getText().equals("")) {
            ...
            if (nomeCheckBox.isSelected()) {
                ...
                Contato resultado = GerenciadorContato.pesquisarContatoExcluidoNome(nome);
                if (resultado == null) {
                    JOptionPane.showMessageDialog(null, "Nenhum contato excluído como " + nome + ".");
                    pesquisarText.requestFocus();
                } else {
                    GerenciadorContato.listaContatos.add(resultado);
                    GerenciadorContato.listaContatosExcluidos.remove(resultado);
                    GerenciadorContato.listaParametro.remove(resultado);
                    JOptionPane.showMessageDialog(null, "Contato recuperado com sucesso.");
                    pesquisarText.requestFocus();
                }
            }
            ...
            if (telefoneCheckBox.isSelected()) {
                ...
                Contato resultado = GerenciadorContato.pesquisarContatoExcluidoTelefone(telefone);
                if (resultado == null) {
                    JOptionPane.showMessageDialog(null, "Nenhum contato excluído com este telefone.");
                    pesquisarText.requestFocus();
                } else {
                    GerenciadorContato.listaContatos.add(resultado);
                    GerenciadorContato.listaContatosExcluidos.remove(resultado);
            ...
            if (celularCheckBox.isSelected()) {
                ...
                Contato resultado = GerenciadorContato.pesquisarContatoExcluidoCelular(celular);
                if (resultado == null) {
                    JOptionPane.showMessageDialog(null, "Nenhum contato excluído com este celular.");
                    pesquisarText.requestFocus();
                } else {
                    GerenciadorContato.listaContatos.add(resultado);
                    GerenciadorContato.listaContatosExcluidos.remove(resultado);
